...
namespace OpenSourceProject.Migrations
{
    ...
    [Migration("20230103120047_addValuesToSubServiceTable")]
    partial class addValuesToSubServiceTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OpenSourceProject.Models.SubService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "60798a41-b014-4fba-bb1b-fd630fe84743",
                            CreatedAt = new DateTime(2023, 1, 3, 14, 0, 46, 416, DateTimeKind.Local).AddTicks(7553),
                            NameAR = "دهان",
                            NameEN = "painting",
                            ServiceId = "ddf7efad-b456-46e4-acb3-84a8b4825c4c",
                            UpdatedAt = new DateTime(2023, 1, 3, 14, 0, 46, 416, DateTimeKind.Local).AddTicks(7572)
                        },
                        new
                        {
                            Id = "c6d6cf71-6419-4f4b-9a32-b2be2ae97c9c",
                            CreatedAt = new DateTime(2023, 1, 3, 14, 0, 46, 416, DateTimeKind.Local).AddTicks(7581),
                            NameAR = "تغيير مواتيير",
                            NameEN = "motors change",
                            ServiceId = "cbe9be46-341a-4193-afcb-96631a160925",
                            UpdatedAt = new DateTime(2023, 1, 3, 14, 0, 46, 416, DateTimeKind.Local).AddTicks(7583)
                        },
                        new
                        {
                            Id = "7968baad-655c-4b9a-9f82-b85938c1af64",
                            CreatedAt = new DateTime(2023, 1, 3, 14, 0, 46, 416, DateTimeKind.Local).AddTicks(7590),
                            NameAR = "غسل سيارات",
                            NameEN = "car wash",
                            ServiceId = "ddf7efad-b456-46e4-acb3-84a8b4825c4c",
                            UpdatedAt = new DateTime(2023, 1, 3, 14, 0, 46, 416, DateTimeKind.Local).AddTicks(7591)
                        });
                });
