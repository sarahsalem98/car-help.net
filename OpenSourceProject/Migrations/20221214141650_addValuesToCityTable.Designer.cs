...
namespace OpenSourceProject.Migrations
{
    ...
    [Migration("20221214141650_addValuesToCityTable")]
    partial class addValuesToCityTable
    {
            ...
            modelBuilder.Entity("OpenSourceProject.Models.City", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 12, 14, 16, 16, 49, 795, DateTimeKind.Local).AddTicks(8044),
                            Name_AR = "الرياض",
                            Name_EN = "El-Reyad",
                            UpdatedAt = new DateTime(2022, 12, 14, 16, 16, 49, 795, DateTimeKind.Local).AddTicks(8060)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 12, 14, 16, 16, 49, 795, DateTimeKind.Local).AddTicks(8065),
                            Name_AR = "جدة",
                            Name_EN = "gada",
                            UpdatedAt = new DateTime(2022, 12, 14, 16, 16, 49, 795, DateTimeKind.Local).AddTicks(8067)
                        });
                });
