...
namespace OpenSourceProject.Migrations
{
    ...
    [Migration("20230115094548_ChangeWhatsappNumber")]
    partial class ChangeWhatsappNumber
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OpenSourceProject.Models.SubService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "86c545fb-ae54-4c55-8154-56e9a20ad543",
                            CreatedAt = new DateTime(2023, 1, 15, 11, 45, 47, 925, DateTimeKind.Local).AddTicks(2111),
                            NameAR = "دهان",
                            NameEN = "painting",
                            ServiceId = "ddf7efad-b456-46e4-acb3-84a8b4825c4c",
                            UpdatedAt = new DateTime(2023, 1, 15, 11, 45, 47, 925, DateTimeKind.Local).AddTicks(2131)
                        },
                        new
                        {
                            Id = "3f5e1466-5bd5-4631-badb-aa51e0b52a1d",
                            CreatedAt = new DateTime(2023, 1, 15, 11, 45, 47, 925, DateTimeKind.Local).AddTicks(2140),
                            NameAR = "تغيير مواتيير",
                            NameEN = "motors change",
                            ServiceId = "cbe9be46-341a-4193-afcb-96631a160925",
                            UpdatedAt = new DateTime(2023, 1, 15, 11, 45, 47, 925, DateTimeKind.Local).AddTicks(2141)
                        },
                        new
                        {
                            Id = "74f93e76-d4a8-4de5-9773-02f3411c791e",
                            CreatedAt = new DateTime(2023, 1, 15, 11, 45, 47, 925, DateTimeKind.Local).AddTicks(2147),
                            NameAR = "غسل سيارات",
                            NameEN = "car wash",
                            ServiceId = "ddf7efad-b456-46e4-acb3-84a8b4825c4c",
                            UpdatedAt = new DateTime(2023, 1, 15, 11, 45, 47, 925, DateTimeKind.Local).AddTicks(2148)
                        });
                });
