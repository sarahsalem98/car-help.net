...
namespace OpenSourceProject.Migrations
{
    ...
    [Migration("20230123071902_addBrandsToDb")]
            ...
            modelBuilder.Entity("OpenSourceProject.Models.Brand", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "45c5f5d3-d732-4620-a6ef-fba41b8ec582",
                            CreatedAt = new DateTime(2023, 1, 23, 9, 19, 1, 606, DateTimeKind.Local).AddTicks(2357),
                            NameAR = "تويوتا",
                            NameEN = "toyota",
                            UpdatedAt = new DateTime(2023, 1, 23, 9, 19, 1, 606, DateTimeKind.Local).AddTicks(2369)
                        },
                        new
                        {
                            Id = "83a68baa-629f-4f73-b38a-fc7d8705afd4",
                            CreatedAt = new DateTime(2023, 1, 23, 9, 19, 1, 606, DateTimeKind.Local).AddTicks(2377),
                            NameAR = "مرسيدس",
                            NameEN = "marcedes",
                            UpdatedAt = new DateTime(2023, 1, 23, 9, 19, 1, 606, DateTimeKind.Local).AddTicks(2378)
                        },
                        new
                        {
                            Id = "772469fb-f48d-408b-9e99-bc90b1ea49e7",
                            CreatedAt = new DateTime(2023, 1, 23, 9, 19, 1, 606, DateTimeKind.Local).AddTicks(2385),
                            NameAR = "BMW",
                            NameEN = "BMW",
                            UpdatedAt = new DateTime(2023, 1, 23, 9, 19, 1, 606, DateTimeKind.Local).AddTicks(2386)
                        });
                });
